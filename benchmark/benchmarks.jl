...
SUITE["Array64Int32"]["JuliaStd"] = @benchmarkable sort!(data) setup=(data = randa(Int32, 64))
SUITE["Array64Int32"]["ChipSort"] = @benchmarkable chipsort_small!(data, Val(V), Val(J)) setup=(data = randa(Int32, 64))
SUITE["Array64Int32"]["CombSort"] = @benchmarkable combsort!(data) setup=(data = randa(Int32, 64))
SUITE["Array64Int32"]["InsertionSort"] = @benchmarkable insertion_sort!(data) setup=(data = randa(Int32, 64))
